...
class TestDataFrames(unittest.TestCase):
    ...
    def test_cov_listwise(self):
        data1 = pd.read_csv('testfiles/data/test1.csv')
        test1_1 = pd.read_csv('testfiles/data/testout_1.1.csv')
    ...
    def test_corr_listwise(self):
        data1 = pd.read_csv('testfiles/data/test1.csv')
        test1_2 = pd.read_csv('testfiles/data/testout_1.2.csv')
    ...
    def test_cov_pairwise(self):
        data1 = pd.read_csv('testfiles/data/test1.csv')
        test1_3 = pd.read_csv('testfiles/data/testout_1.3.csv')
    ...
    def test_corr_pairwise(self):
        data1 = pd.read_csv('testfiles/data/test1.csv')
        test1_2 = pd.read_csv('testfiles/data/testout_1.4.csv')
    ...
    def test_ew_cov(self):
        ...
        test = pd.read_csv('testfiles/data/testout_2.1.csv')
    ...
    def test_ew_corr(self):
        data = pd.read_csv('testfiles/data/test2.csv')
        test = pd.read_csv('testfiles/data/testout_2.2.csv')
    ...
    def test_cov_ew_cov_corr(self):
        data = pd.read_csv('testfiles/data/test2.csv')
        test = pd.read_csv('testfiles/data/testout_2.3.csv')
    ...
    def test_near_psd(self):
        ...
        test = pd.read_csv('testfiles/data/testout_3.1.csv')
        out = pd.DataFrame(near_psd(data))
        
        self.assertDataFramesAlmostEqual(out, test)
        
    def test_near_psd_corr(self):
        data = pd.read_csv('testfiles/data/testout_1.4.csv')
        test = pd.read_csv('testfiles/data/testout_3.2.csv')
        out = pd.DataFrame(near_psd(data))
    ...
    def test_higham_psd(self):
        data = pd.read_csv('testfiles/data/testout_1.3.csv')
        test = pd.read_csv('testfiles/data/testout_3.3.csv')
    ...
    def test_higham_psd_corr(self):
        data = pd.read_csv('testfiles/data/testout_1.4.csv')
        test = pd.read_csv('testfiles/data/testout_3.4.csv')
        out = pd.DataFrame(Higham_psd(data))
        
        self.assertDataFramesAlmostEqual(out, test)
        
    def test_chol_psd(self):
        data = pd.read_csv('testfiles/data/testout_3.1.csv')
        test = pd.read_csv('testfiles/data/testout_4.1.csv')
        out = pd.DataFrame(chol_psd(data.to_numpy()))
        
        self.assertDataFramesAlmostEqual(out, test)
    
    def test_5_1(self):
        data = pd.read_csv('testfiles/data/test5_1.csv')
        test = pd.read_csv('testfiles/data/testout_5.1.csv')
    ...
    def test_5_2(self):
        data = pd.read_csv('testfiles/data/test5_2.csv')
        test = pd.read_csv('testfiles/data/testout_5.2.csv')
        samples = multivariate_normal_simulation(data.to_numpy(),100000)
        out = calculate_cov(pd.DataFrame(samples))
    ...
    def test_5_3(self):
        data = pd.read_csv('testfiles/data/test5_3.csv')
        test = pd.read_csv('testfiles/data/testout_5.3.csv')
    ...
    def test_5_4(self):
        data = pd.read_csv('testfiles/data/test5_3.csv')
        test = pd.read_csv('testfiles/data/testout_5.4.csv')
    ...
    def test_5_4(self):
        data = pd.read_csv('testfiles/data/test5_2.csv')
        test = pd.read_csv('testfiles/data/testout_5.5.csv')
    ...
    def test_6_1(self):
        data = pd.read_csv('testfiles/data/test6.csv')
        test = pd.read_csv('testfiles/data/test6_1.csv')
    ...
    def test_6_2(self):
        data = pd.read_csv('testfiles/data/test6.csv')
        test = pd.read_csv('testfiles/data/test6_2.csv')
    ...
    def test_7_1(self):
        ...
        test = pd.read_csv('testfiles/data/testout7_1.csv')
    ...
    def test_7_2(self):
        ...
        test = pd.read_csv('testfiles/data/testout7_2.csv')
    ...
    def test_7_3(self):
        ...
        test = pd.read_csv('testfiles/data/testout7_3.csv')
        y = data[['y']].values
    ...
    def test_8_1(self):
        data = pd.read_csv('testfiles/data/test7_1.csv')
        test = pd.read_csv('testfiles/data/testout8_1.csv')
        mu, sigma = fit_normal(data)
    ...
    def test_8_2(self):
        data = pd.read_csv('testfiles/data/test7_2.csv')
        test = pd.read_csv('testfiles/data/testout8_2.csv')
        df, loc, scale = fit_t(data)
    ...
    def test_8_3(self):
        data = pd.read_csv('testfiles/data/test7_2.csv')
        test = pd.read_csv('testfiles/data/testout8_3.csv')
        df, loc, scale = fit_t(data)
    ...
    def test_8_4(self):
        data = pd.read_csv('testfiles/data/test7_1.csv')
        test = pd.read_csv('testfiles/data/testout8_4.csv')
        mu, sigma = fit_normal(data)
    ...
    def test_8_5(self):
        data = pd.read_csv('testfiles/data/test7_2.csv')
        test = pd.read_csv('testfiles/data/testout8_5.csv')
        df, loc, scale = fit_t(data)
    ...
    def test_8_6(self):
        data = pd.read_csv('testfiles/data/test7_2.csv')
        test = pd.read_csv('testfiles/data/testout8_6.csv')
        df, loc, scale = fit_t(data)
        t_dist = t(df, loc, scale)
        simulations = t_dist.ppf(np.random.rand(10000))
    ...
    def test_9_1(self):
        ...
        portfolios = pd.read_csv('testfiles/data/test9_1_portfolio.csv')
        test = pd.read_csv('testfiles/data/testout9_1.csv')
